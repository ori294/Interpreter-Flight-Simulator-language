...
class OpenServerCommand : public Command {
 ...
 public:
  OpenServerCommand() {
    ...
    data_about_airplane.insert(make_pair(4, make_pair("/instrumentation/attitude-indicator/indicated-pitch-deg", "0")));
    data_about_airplane.insert(make_pair(5, make_pair("/instrumentation/attitude-indicator/indicated-roll-deg", "0")));
    data_about_airplane.insert(make_pair(6, make_pair("/instrumentation/attitude-indicator/internal-pitch-deg", "0")));
